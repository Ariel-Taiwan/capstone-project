...
def main():
    ...
    input_col = ["layer","category", "indomain", "image_name", "decode_url", "image_urls"]
    ...
    for i in df.index:
        if type(df["decode_url"][i]) is str:
            ...
            if query_res is not None:
                ...
                phishing_list.append([is_exist, is_shorturl, df["layer"][i], df["category"][i], df["indomain"][i], df["image_name"][i], df["decode_url"][i], url, df["image_urls"][i]])
    ...
    output_col = ["exist", "shorturl", "layer","category", "indomain", "image_name", "decode_url", "unshorten_url", "image_urls"]
