...
def main():
    ...
    # Input .csv directory
    input_list_directory = os.path.abspath("/home/server/QRcode_Crawler/Image_Crawler/Imagecapture/spiders/input/urls") + '/' + sys.argv[1] 
    
    # Output .csv directory
    output_list_directory = os.path.abspath("/home/server/QRcode_Crawler/Image_Crawler/Imagecapture/spiders/output") + '/' + sys.argv[2] 

    # Read a image info category,indomain,layer,urls
    col_list = ["category", "indomain", "layer", "urls"] 
